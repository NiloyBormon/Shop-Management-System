...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['profile'])) {
	try {
		updateProfile((int) $_SESSION['user_id'], trim((string) $_POST['username']), trim((string) $_POST['email']));
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['password'])) {
	try {
		changePassword((int) $_SESSION['user_id'], (string) $_POST['current_password'], (string) $_POST['new_password']);
